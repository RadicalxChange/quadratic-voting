...
function Event({ query }) {
  ...
  const downloadTXT = () => {
    ...
    const text = data.event.voters
      .map((voter, _) => `https://colorado.qv.radicalxchange.org/vote?user=${voter.id}`)
      .join("\n");
    ...
    <Layout event>
      ...
      <div className="event">
        ...
        <div className="event__section">
          ...
          <input
            value={`https://colorado.qv.radicalxchange.org/event?id=${query.id}`}
            readOnly
          />
        </div>
        ...
        data ? (
          <div className="event__section">
            ...
            <input
              value={`https://colorado.qv.radicalxchange.org/event?id=${query.id}&secret=${query.secret}`}
              readOnly
            />
          </div>
        ) : null}
          ...
          <div className="event__section">
            ...
            <textarea
              ...
              value={data.event.voters
                .map(
                  (voter, _) => `https://colorado.qv.radicalxchange.org/vote?user=${voter.id}`
                )
                .join("\n")}
              readOnly
            />
