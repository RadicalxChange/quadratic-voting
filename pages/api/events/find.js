...
export default async (req, res) => {
  ...
  if (id) {
    ...
    if (user) {
      ...
      // Set response object survey_data field to value retrieved from DB
      response.survey_data = user.survey_data;
      ...
      event_data.survey_questions = JSON.parse(event_data.survey_questions)
